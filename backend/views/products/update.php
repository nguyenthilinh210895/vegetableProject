...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="number"
               name="quantity"
               id="quantity"
               value="<?php echo isset($_POST['quantity']) ? $_POST['quantity'] : $product['quantity']; ?>"
               class="form-control"
        />
    </div>
    <div class="form-group">
        ...
        <img src="assets/uploads/<?php echo $product['avatar']; ?>" height="80"/>
        <?php endif; ?>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control"
                  name="content"
                  id="content"
        ><?php echo isset($_POST['content']) ? $_POST['content'] : $product['content']; ?></textarea>
    </div>
    <div class="form-group">
